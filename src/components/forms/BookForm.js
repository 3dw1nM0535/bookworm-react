				...
				<Grid columns={2} fluid='true' stackable>
					<Grid.Row>
						<Grid.Column>
							<Form.Field error={!!errors.title}>
								...
								<input 
									...
									name='title'
									id='title'
									placeholder='Provide Book Title'
									value={data.title}
							...
							<Form.Field error={!!errors.authors}>
								...
								<input 
									...
									name='authors'
									id='authors'
									placeholder="Provide Authors name"
									value={data.authors}
									onChange={this.onChange}
								/>
						...
						<Grid.Column>
							...
							{ this.state.covers.length > 1 && <a role='button' tabIndex={0} onClick={this.changeCover}>Another cover</a> }
						</Grid.Column>
					</Grid.Row>
					<Grid.Row>
